...
f = open(archivo, 'w')
f.write("# Integration interval [{0}, {1}]\n".format(Xmin, Xmax))
f.write("# Degree of the B-splines functions {0}\n".format(grado))
f.write("# Num of intervals {0} ans size of the basis set {1} en x\n".format(N_intervalos_x, N_base_x))
f.write("# Total size of the matrices N_dim = N_base_r = {0}\n".format(N_dim))
